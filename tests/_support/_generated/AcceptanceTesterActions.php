<?php  //[STAMP] b1ae34019af96763c822e84b183a005e
...
trait AcceptanceTesterActions
{
     ...
     * @throws \Codeception\Exception\ModuleException
     * @throws \Exception
     * @see \Helper\Acceptance::waitTillPageLoad()
     */
    public function waitTillPageLoad($element) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('waitTillPageLoad', func_get_args()));
    }
     ...
     * @param $elements
     * @throws \Codeception\Exception\ModuleException
     * @see \Helper\Acceptance::checkSortOnPage()
     */
    public function checkSortOnPage($elements) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('checkSortOnPage', func_get_args()));
    }
     ...
     * @param $valuesList
     * @throws \Codeception\Exception\ModuleException
     * @see \Helper\Acceptance::checkSort()
     */
    public function checkSort($valuesList) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('checkSort', func_get_args()));
    }
     ...
     * @return mixed
     * @throws \Codeception\Exception\ModuleException
     * @see \Helper\Acceptance::getCssProperty()
     */
    public function getCssProperty($locator, $cssProperty) {
